...
void app_main()
{
    ...
    // ====================================================================
	tft_pins_global.miso_gpio = 19; 
	tft_pins_global.mosi_gpio = 23;
	tft_pins_global.sclk_gpio = 18;
	tft_pins_global.cs_gpio = 5;
	tft_pins_global.dc_gpio = 15;
	tft_pins_global.rst_gpio = 4;
	tft_pins_global.bckl_gpio = 2;
	tft_pins_global.bckl_off_value = 0;
	tft_pins_global.bckl_on_value = 1;
    ...
    spi_lobo_bus_config_t buscfg={
        .miso_io_num=tft_pins_global.miso_gpio,				// set SPI MISO pin
        .mosi_io_num=tft_pins_global.mosi_gpio,				// set SPI MOSI pin
        .sclk_io_num=tft_pins_global.sclk_gpio,				// set SPI CLK pin
        .quadwp_io_num=-1,
        .quadhd_io_num=-1,
    ...
    spi_lobo_device_interface_config_t devcfg={
		...
		.spics_ext_io_num=tft_pins_global.cs_gpio,           // external CS pin
	...
	printf("==============================\r\n");
    printf("Pins used: miso=%d, mosi=%d, sck=%d, cs=%d\r\n", tft_pins_global.miso_gpio, tft_pins_global.mosi_gpio, tft_pins_global.sclk_gpio, tft_pins_global.cs_gpio);
	printf("==============================\r\n\r\n");
